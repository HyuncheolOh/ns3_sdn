...
/*
  ...
  DpctlExecute (swtch, "flow-mod cmd=add,table=0,prio=500 "
		  "eth_type=0x800,ip_dst=10.1.1.3 apply:output=1");
...
*/
  ...
  DpctlExecute (swtch, "flow-mod cmd=add,table=0,prio=500 "
		  "eth_type=0x806,ip_dst=10.1.1.3 apply:output=1");
