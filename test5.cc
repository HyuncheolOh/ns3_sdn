...
main (int argc, char *argv[])
{
  ...
  /*
  // Connect host 3 to second switch
  pair = NodeContainer (hosts.Get (2), switches.Get (0));
  pairDevs = csmaHelper.Install (pair);
  hostDevices.Add (pairDevs.Get (0));
  switchPorts [0].Add (pairDevs.Get (1));

  // Connect host 4 to second switch
  pair = NodeContainer (hosts.Get (3), switches.Get (1));
  pairDevs = csmaHelper.Install (pair);
  hostDevices.Add (pairDevs.Get (0));
  switchPorts [1].Add (pairDevs.Get (1));
*/
